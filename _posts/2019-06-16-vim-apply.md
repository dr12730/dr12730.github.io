...
* [通过的代码补全插件 coc.vim](#通过的代码补全插件-cocvim)
    ...
    * [代码补全](#代码补全)
        * [触发模式](#触发模式)
        * [使用 `<Tab>` 或自定义键完成触发器](#使用-tab-或自定义键完成触发器)
        * [完善补全体验](#完善补全体验)
        * [补全来源](#补全来源)
            * [内嵌来源](#内嵌来源)
            * [配置补全源](#配置补全源)
    ...
    * [如何使用配置文件](#如何使用配置文件)
        * [打开配置文件](#打开配置文件)
        * [解析配置文件](#解析配置文件)
        * [默认的 COC 配置](#默认的-coc-配置)
    * [使用代码片段](#使用代码片段)
        * [片段补全](#片段补全)
        * [配置片段工作流](#配置片段工作流)
        * [使用来自 VSCode 的代码片段](#使用来自-vscode-的代码片段)
    * [扩展](#扩展)
        * [为什么需要 coc 扩展](#为什么需要-coc-扩展)
            * [coc 扩展特性](#coc-扩展特性)
        * [管理 coc 扩展](#管理-coc-扩展)
            * [安装扩展](#安装扩展)
            * [自动更新](#自动更新)
            * [删除插件](#删除插件)
            * [通过 CocList 管理插件](#通过-coclist-管理插件)
    * [使用工作区](#使用工作区)
        * [解析工作区文件夹](#解析工作区文件夹)
        * [管理工作区文件夹](#管理工作区文件夹)
        * [禁用工作区文件夹支持](#禁用工作区文件夹支持)
        * [持久化工作区文件夹](#持久化工作区文件夹)
* [中文排版插件 PanGu](#中文排版插件-pangu)
* [文件目录和搜索](#文件目录和搜索)
